      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'CodePush / OTA Updates', slug: 'guides/codepush' },
            { label: 'Flutter CodePush', slug: 'guides/codepush-flutter' },
            { label: 'React Native CodePush', slug: 'guides/codepush-react-native' },
